...
def parse_args(args):
  ...
  parser.add_argument('--weights', '-w', type=lambda x: [float(t) for t in x.split(',')],
                      help='Comma-separated list of multipliers per file')
